...
import { ArrowRight, TrendingUp, Users, Database, Clock } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "2000+", label: "Enterprise Clients", icon: Users },
    { value: "99.9%", label: "Platform Uptime", icon: Clock },
    { value: "50TB+", label: "Data Processed Daily", icon: Database },
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 size-96 bg-secondary/20 rounded-full blur-3xl opacity-20" />
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join industry leaders who've transformed their decision-making with DataFlow Analytics. 
                Start your data journey with our comprehensive business intelligence platform.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by Fortune 500 companies and data-driven organizations
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SOC 2 compliant with bank-level data protection
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Go live in 48 hours with our expert implementation team
              </p>
            </div>
          </div>
        </div>
